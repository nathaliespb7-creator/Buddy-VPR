...
function showLoadError(message: string) {
  ...
  if (!rootEl) return;
  rootEl.innerHTML = [
    '<div style="min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:2rem;font-family:\'Manrope\',sans-serif;background:hsl(160 50% 97%);">',
